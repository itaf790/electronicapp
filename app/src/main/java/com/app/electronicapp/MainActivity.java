...
// t3ref fire
        ...
        insert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(MainActivity.this,confirmuser.class);
            ...
            storageReference2.putFile(FilePathUri).continueWithTask(
                ...
                public void onSuccess(Uri uri) {
                    ...
                    uploadinfo imageUploadInfo = new uploadinfo(
                            TempImagefirstname,TempImagelastname,TempImagephone,TempImageadress,TempImagegender,TempImagetime,TempImagedate,TempImageduration,uri.toString());
